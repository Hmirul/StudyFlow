    ...
    >
      <View style={styles.formCardContent}>
        <View style={styles.formIconContainer}>
          <Ionicons name="card" size={32} color="#ff7b3a" />
        </View>
      ...
      <View style={styles.content}>
        <View style={styles.bannerContainer}>
          ...
          <View style={styles.bannerTextContainer}>
            <Text style={styles.bannerTitle}>Study Flashcards</Text>
            <Text style={styles.bannerSubtitle}>Select your form to access subject flashcards</Text>
          </View>
        </View>
